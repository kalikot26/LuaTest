...
local OnlyRareSeeds = false -- Flag for new toggle
local RareSeeds = {
    Mythical = true,
    Divine = true,
    Prismatic = true
...
local function BuyAllSelectedSeeds()
    for Seed, Stock in pairs(SeedStock) do
...
local function HarvestPlant(Plant: Model)
    ...
    local Mutation = Plant:FindFirstChild("Mutation")
    if Mutation and Mutation.Value ~= "tranquil" then return end
